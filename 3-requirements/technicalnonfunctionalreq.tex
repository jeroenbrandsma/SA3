...
\includegraphics[scale=0.8]{C:/Users/admin/Desktop/M1/Performance.jpg}
...
\reqRow{sec}{1}{Must}{All communication to, from and within the system are encrypted.}
	...
	\reqRow{sec}{6}{Must}{Backup copies are stored in a secure location which is not in the same area as the system (50 km).} % WM: maybe make area more specific, like range of 50 km or something
