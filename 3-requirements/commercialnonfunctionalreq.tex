...
\begin{longtable}{L{0.1\textwidth} L{0.12\textwidth} L{0.7\textwidth}}
	...
	\reqRow{cnfr}{1}{Must}{The system is affordable. The initial price of the system is lower than 70\%\ of the competitors price in the same market.}
	
	\reqRow{cnfr}{2}{Must}{The sensors have a good quality, so we don't have to replace the sensors often. The expected lifetime of the sensors should be at least three years.}
