...
The figure above gives an abstract view of the layers of the SFM. 
he layering is done according to the layering Martin Fowler proposes for enterprise applications \cite{Fowler:2002:PEA:579257,Fowler:web:servicelayer}.
...
The layers are specified into more detail in figure \ref{fig:logical}.
\begin{figure}[H]
	%\centering
...
\begin{figure}[H]
	%\centering
	\includegraphics[keepaspectratio=true,width=0.9\textwidth]{{\viewimages/sensorssequence}.jpg}
...
First the sensor data get's pre processed. 
...
The the L1 norm smoothening fluctuates more than the Hodrick-Prescott function. This way, the long term and short term differences can be analyzed better.\\
