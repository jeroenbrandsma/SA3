...
\begin{tabular}{L{0.2\textwidth} L{0.7\textwidth} L{0.1\textwidth}}
	...
	Fakambi & Coaching session  project meeting, work on Non functional requirements & \\ \midrule
...
\begin{tabular}{p{0.2\textwidth} p{0.7\textwidth} p{0.1\textwidth}}
   \textbf{Person} & \textbf{Task} & \textbf{Hours} \\ \midrule
	...
	Fakambi & Coaching session, meetings, Non functional requirements and Risk assessment & \\ \midrule
