...
\begin{longtable}{L{0.1\textwidth} L{0.12\textwidth} L{0.7\textwidth}}
	...
	\reqRow{rel}{Must}{The system must detect if a sensor supplies values that are not correct for the specific real world environment.} 
...
\begin{longtable}{L{0.1\textwidth} L{0.12\textwidth} L{0.7\textwidth}}
	...
	\reqRow{res}{Must}{The system recovers from failures without the performance or the functionality of the system being affected.}
	...
	\reqRow{res}{Must}{Backup copies are stored in a location which is not in the same area as the system (50 km away).}
