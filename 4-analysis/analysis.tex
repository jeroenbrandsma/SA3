...
\chapter{Analysis}
\label{ch:analysis}
This chapter describes the analysis of the system. It lists the assumptions that are made about the system and its environment. After this, an overview of the high-level design decisions is given.
