	...
	\begin{tabular}{L{0.2\textwidth} L{0.6\textwidth}}
		...
		\textbf{Design decisions} 	& \\
			...
			\begin{tabular}{l|lllll}
				...
				Detection algorithm & \ref{fr:detect-faultysensor}, \ref{REL:sensor-incorrectvalues} & \nsl{s}{faultysensor} & \nsl{to}{faultysensor} &  & \nsl{nr}{detection}  \\
	...
	\begin{tabular}{L{0.2\textwidth} L{0.6\textwidth}}
		...
		\textbf{Design decisions} 	& \\
			...
			\begin{tabular}{l|lllll}
				...
				Database cluster & \ref{AVA:uptime}, \ref{AVA:downtime} &  & \nsl{to}{cluster} &  & \nsl{nr}{clusterdb}  \\
				Analytic cluster & \ref{AVA:uptime}, \ref{AVA:downtime} &  & \ref{to:cluster} &  & \nsl{nr}{clusteranalytic} \\
				Multiple data centers & \ref{AVA:uptime}, \ref{AVA:downtime} &  & \nsl{to}{datacentre} &  & \nsl{nr}{datacenters} \\
				Arduino               & \ref{AVA:uptime}, \ref{AVA:downtime} & \nsl{s}{arduinofail} &  & \nsl{r}{arduinofail} &  \\
