...
\begin{longtable}{L{0.1\textwidth} L{0.12\textwidth} L{0.7\textwidth}}
	...
	\reqRow{sec}{6}{Must}{Backup copies are stored in a secure location which is not in the same building as the system.}
	\reqRow{sec}{5}{Must}{All system data must be backed up every 24 hours and the backup copies stored in a secure location which is not in the same building as the system.}
...
\begin{longtable}{L{0.1\textwidth} L{0.12\textwidth} L{0.7\textwidth}}
	...
	\reqRow{scale}{2}{Must}{Cassandra is used as database for the storage of the sensordata} %
	\bottomrule
\end{longtable}
