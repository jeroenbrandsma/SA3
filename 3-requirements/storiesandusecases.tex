...
\pgfplotstabletypeset[%
	...
	Stakeholders and interests & \compactCell{
		...
		\textbf{Citizens}: The citizens want to be alerted if there is a high enough probability of a flood occuring}
		\\
	Primary actor & System\\
...
\pgfplotstabletypeset[%
	...
	Stakeholders and interests & \compactCell{
		...
		\textbf{Safety region}: The safety region wants to get updates on the imminent flood}
		\\
