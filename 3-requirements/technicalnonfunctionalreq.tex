...
\begin{longtable}{L{0.1\textwidth} L{0.12\textwidth} L{0.7\textwidth}}
	...
	\reqRow{res}{3}{Must}{The system continues to function with the same \qos in a situation where up to 10\% of the sensors suffer from failures.} % WM: is 5% realistic?
	\bottomrule
\end{longtable}
...
>>>>>>> c4b1f8e221b1b11ac8dde453c2709967a7b3515d
	\bottomrule
\end{longtable}
...
=======
	\reqRow{sec}{4}{Must}{All communication to, from and between different subsystems of the system are encrypted.}
	% WM: does communication within the system mean between the different components of the system?
