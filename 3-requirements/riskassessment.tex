...
%\begin{longtable}{L{0.1\textwidth} L{0.0\textwidth} L{0.7\textwidth}}
	...
	%\reqRow{risk}{2}{}{The system sends warnings of a non-excising flood (false positive).}
...
\begin{longtable}{L{0.1\textwidth} L{0.0\textwidth} L{0.7\textwidth}}
	\textbf{Nr.} &  & \textbf{Description} \\
	\reqRow{t-risk}{1}{}{The warning system does not detect floods in time }  
	%Probability of Occurence : Low because the system is realiable
	%Timeframe
	%{}Consequences : Severe because of the loss of human lives }
	%Decision
	\reqRow{t-risk}{2}{}{The system sends warnings of a non-excising flood (false positive), making people more negligent to future messages.}
	% Probability of Occurence : LOW
	%Timeframe
	%Consequences
	%Decision
	\reqRow{t-risk}{3}{}{The system can't send messages to the necessary people because the communication platform is also destroyed by the flood.}
	%Probability of Occurence :MEDIUM
	%Timeframe
	%Consequences
	%Decision
	\reqRow{t-risk}{4}{}{The system sends incorrect information, causing extra damage.}
	%Probability of Occurence :LOW
	%Timeframe
	%Consequences
	%Decision
	\reqRow{t-risk}{5}{}{Hacker get access to the system} % is this riskworthy?
	%Probability of Occurence :LOW
...
%\begin{longtable}{L{0.1\textwidth} L{0.0\textwidth} L{0.7\textwidth}}
	...
	%\reqRow{risk}{2}{}{The money invested in the fabrication and achievement of the product/system isn't "covered" by the sales (shortfall/deficit)}
...
\begin{longtable}{L{0.1\textwidth} L{0.0\textwidth} L{0.7\textwidth}}
	\textbf{Nr.} &  & \textbf{Description} \\
	\reqRow{b-risk}{1}{}{Wrong estimation of the budget}
	%Probability of Occurence :Medium
	%Timeframe
	%Consequences
	%Decision
	\reqRow{b-risk}{2}{}{The money invested in the fabrication of the system isn't "covered" by the sells (shortfall/deficit)}
	%Probability of Occurence :Medium
	%Timeframe
	%Consequences
	%Decision
	\reqRow{b-risk}{3}{}{Competitors lowering their prices so our company has to reduce its} % is this riskworthy?
	%Probability of Occurence : Medium
	%Timeframe
	%Consequences
	%Decision
	\reqRow{b-risk}{4}{}{The sensors company become bankrupt}
	%Probability of Occurence :Low
>>>>>>> 3d10bbb5bb9a6591f331a9abca70c467b324619d
	%Timeframe
...
%\begin{longtable}{L{0.1\textwidth} L{0.0\textwidth} L{0.7\textwidth}}
	%\textbf{Nr.} &  & \textbf{Description} \\
	%\reqRow{risk}{1}{}{The project isn't finished at the deadline.}
	\textbf{ S-RISK1 The project isn't finished at the deadline} \\
	\textit {Probability of Occurence}  : Low
=======
\begin{longtable}{L{0.1\textwidth} L{0.0\textwidth} L{0.7\textwidth}}
	\textbf{Nr.} &  & \textbf{Description} \\
	\reqRow{s-risk}{1}{}{The project isn't finished at the deadline.}
	%Probability of Occurence :Low
>>>>>>> 3d10bbb5bb9a6591f331a9abca70c467b324619d
	%Timeframe
