...
Figure~\ref{fig:activity-controlpanel} shows the activity diagram related to the control panel. As can be seen in this figure, the maintainer can login and view the faulthy sensors and the issued warnings.
