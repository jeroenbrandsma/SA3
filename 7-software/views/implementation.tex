...
\begin{itemize}
	\item Database: This is the database that holds all the stored data of the system.
...
\begin{figure}[H]
	%\centering
	\includegraphics[keepaspectratio=true,width=1.0\textwidth]{{\viewimages/packages}.jpg}
