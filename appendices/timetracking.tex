...
\begin{tabular}{p{0.2\textwidth} p{0.7\textwidth} p{0.1\textwidth}}
   \textbf{Person} & \textbf{Task} & \textbf{Hours} \\ \midrule
	Eedema &  &  \\ \midrule
	Putra & Coaching session, meetings, presentation prep., improving business rationale, review chapter 2, working on chapter 5,6,7 & 12 \\ \midrule
	Fakambi & & \\ \midrule
	Schaefers & Researched on sensors and other EWS's. Then created the system architecture model diagram and vision diagram for the presentation I had to do. Created/improved other diagrams. Enhanced the business cost section. \\ \midrule
	Brandsma & Coaching session, Meeting, Reviewing group 1, architectural vision, use-cases & 10\\ \midrule
	Menninga & Coaching session, presentation prep., meeting, improvements FR and risks, review ch. 4 & 11.0 \\ \midrule
\end{tabular}
