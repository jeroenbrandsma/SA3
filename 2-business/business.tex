...
The price of the Airborne A2xA4 is 34 000 dollars (31273.2$\euro{}$) and the system will use fifty UAVs . Total cost = dollars ( 15 636 600 $\euro{}$). The number of UAVs released depends on the size of the flooded area but the system has fifty UAVs available. \\

The maintenance costs of the UAV for all of them are rising to 500$\euro{}$ per UAV per year so for the first ten years of the project : 500*50*10=250 000$\euro{}$. \\

Theee maintainers will receive a trainning to learn how to pilot the UAV's: 3 217*3= 9651$\euro{}$. \\
Total costs : 15 895 651$\euro{}$. \\
...
\begin{table}[H]
	...
	Maintenance costs per year & $\euro{}$31.725.000\\
	Server costs & $\euro{}$319.374\\
	UAVs & 15.895.651$\euro{}$\\
	Total cost & 432.180.025 $\euro{}$\\
	\bottomrule
	\end{tabular}
